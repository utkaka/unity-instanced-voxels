...
namespace InstancedVoxels.Voxelization.Colors {
	...
	public struct FillInnerBorderVoxelColorJob : IJob {
		...
		public FillInnerBorderVoxelColorJob(VoxelsBox box, NativeArray<WeightedVoxel> weightedVoxels, NativeArray<bool> outerVoxels, NativeArray<int> voxelBones, NativeArray<bool> voxelColored, NativeArray<float3> voxelColors, NativeQueue<int> borderVoxels) {
			_box = box;

...
using com.utkaka.InstancedVoxels.Runtime.Rendering.BrgRenderer.CustomShader;
...
{
    public class BrgCustomShaderRendererTest: VoxelRendererPerformanceTest<BrgCustomShaderRenderer> {
